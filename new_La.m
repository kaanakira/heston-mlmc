function [sums, cost] = new_La(l,N,~)
%-------------------------------------------------------
%
% level L, acceleration
% new scheme on the fine grid and truncated version on the coarse grid
%
...
for N1 = 1:10000:N
  ...
  for n = 1:nc
      ...
      % Lévy area approx
      A = randn(M,N2).*sqrt(1/12 * hf^2 + 1/12*hf*((dWf1).^2 +(dWf2).^2));
      ...
      % Truncated version for the coarse level
